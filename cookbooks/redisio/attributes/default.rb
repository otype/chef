# Cookbook Name:: cookbooks.redisio
# Attribute::default
#
...
default['cookbooks.redisio']['safe_install'] = true

#Tarball and download related defaults
default['cookbooks.redisio']['mirror'] = "https://redis.googlecode.com/files"
default['cookbooks.redisio']['base_name'] = 'redis-'
default['cookbooks.redisio']['artifact_type'] = 'tar.gz'
default['cookbooks.redisio']['version'] = '2.6.10'
default['cookbooks.redisio']['base_piddir'] = '/var/run/redis'

#Default settings for all redis instances, these can be overridden on a per server basis in the 'servers' hash
default['cookbooks.redisio']['default_settings'] = {
  'user'                   => 'redis',
  'group'                  => 'redis',
  'homedir'                => homedir,
  'shell'                  => shell,
...
default['cookbooks.redisio']['servers'] = nil
